...
export default function page(){
    return(
        ...
        <Image src="/images/IMG_2479.JPG" alt="" width={990} height={565}
     ...
     <div className="">
      ...
      <div>
        <Image src='/images/climateChangecartoon3.jpeg' alt="" width={467} height={369}/>
      </div>
     </div>
     <div className="md:grid md:grid-cols-2 md:gap-3 space-y-6 md:space-y-0">
     <div>
        <Image src='/images/climateChangecartoon4.jpeg' alt="" width={467} height={369}/>
      </div>
      <div>
        <Image src='/images/climatechangecartoon5.jpeg' alt="" width={467} height={369}/>
      </div>
     </div>
